...
pub(crate) fn load_ui_font_size() -> u16 {
    load_font_size("superscience-ui-font-size", 14, 0, 30)
}

pub(crate) fn load_code_font_size() -> u16 {
    load_font_size("superscience-code-font-size", 12, 0, 30)
}
...
pub(crate) fn load_ui_font_family() -> String {
    load_font_family("superscience-font-ui")
}

pub(crate) fn load_code_font_family() -> String {
    load_font_family("superscience-font-mono")
}
