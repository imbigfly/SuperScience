...
pub(super) fn Sidebar(
    ...
    open_demo_actions: Callback<(web_sys::MouseEvent, String, String, bool)>,
                                ...
                                <div class="side-item-wrap">
                                    <button class="side-item ses" data-demo-id=d.id.clone() title=d.title.clone()
                                        ...
                                        on:contextmenu=move |ev: web_sys::MouseEvent| {
                                            ev.prevent_default();
                                            ev.stop_propagation();
                                            open_demo.call((ev, d_menu.id.clone(), d_menu.title.clone(), d_menu.user_saved));
                                        }>
                                        <span class="dot"></span>
                                    ...
                                    <button type="button" class="session-actions"
                                        ...
                                        on:click=move |ev: web_sys::MouseEvent| {
                                            ev.prevent_default();
                                            ev.stop_propagation();
                                            open_demo_btn.call((ev, d_actions.id.clone(), d_actions.title.clone(), d_actions.user_saved));
