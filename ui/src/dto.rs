//! Data model for the UI. The actual types live in the shared `superscience-dto`
//! crate (`crates/superscience-dto`), which owns the serde contract between the UI and
