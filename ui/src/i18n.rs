...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "models.advanced") => Some("Advanced"),
        ...
        (Locale::En, "models.reuse_key") => Some("Using the saved key for {host} — leave blank to reuse."),
        ...
        (Locale::En, "models.add_provider_title") => Some("Add custom provider"),
        (Locale::En, "models.edit_provider_title") => Some("{name} — Model management"),
        (Locale::En, "models.tag.custom") => Some("Custom"),
        (Locale::En, "models.status.live") => Some("Live"),
        (Locale::En, "models.field.endpoint") => Some("ENDPOINT"),
        (Locale::En, "models.field.api_key_short") => Some("API KEY"),
        (Locale::En, "models.field.models") => Some("MODELS"),
        (Locale::En, "models.count") => Some("{n} models"),
        (Locale::En, "models.modify_key") => Some("Modify"),
        (Locale::En, "models.card.models") => Some("Models"),
        ...
        (Locale::En, "share.image_footer") => Some("Shared from 天成科研助手"),
        ...
        (Locale::En, "review.transition_to_reviewer") => Some("天成科研助手 nudged Reviewer: please check this response"),
        (Locale::En, "review.transition_to_agent") => Some("Reviewer nudged 天成科研助手: findings found, please revise"),
        (Locale::En, "review.transition_passed") => Some("Reviewer nudged 天成科研助手: no issues found, please continue"),
        ...
        (Locale::En, "right.no_artifacts.body") => Some("Markdown tables, CSV blocks, equations, and file previews from 天成科研助手 appear here."),
        ...
        (Locale::En, "settings.storage.data_dir_hint") => {
            Some("Where 天成科研助手 keeps its database, Python environment and plugins on this machine")
        }
        ...
        (Locale::En, "chat.assistant") => Some("天成科研助手"),
        ...
        (Locale::En, "caps.tile.env_setup.blurb") => Some("Check and prepare local Python, R, Node, sci, pixi, and officecli."),
        ...
        (Locale::En, "runtime_setup.title") => Some("Prepare this computer"),
        (Locale::En, "runtime_setup.why") => Some("Analysis, figures, literature search, Office files, and the built-in biology tools need local runtimes. The installer does not ship them. This step checks and downloads only what is missing — you can keep using the app while it runs."),
        (Locale::En, "runtime_setup.scope") => Some("Installs uv/Python, an R kernel, Node/sci, pixi, and officecli. It will not overwrite an existing R, preinstall Seurat, or register SciMaster for you. The SciMaster key can wait."),
        (Locale::En, "runtime_setup.skip_hint") => Some("Skip to use the app now. Missing tools can be installed later from “Set up local environment”. Collapse keeps the install running."),
        (Locale::En, "runtime_setup.start") => Some("Start setup"),
        (Locale::En, "runtime_setup.skip") => Some("Not now"),
        (Locale::En, "runtime_setup.cancel") => Some("Cancel install"),
        (Locale::En, "runtime_setup.collapse") => Some("Hide"),
        (Locale::En, "runtime_setup.expand") => Some("Show setup"),
        (Locale::En, "runtime_setup.chip.preparing") => Some("Preparing environment {done}/{total}"),
        (Locale::En, "runtime_setup.chip.ready") => Some("Environment ready"),
        (Locale::En, "runtime_setup.chip.incomplete") => Some("Environment not ready"),
        (Locale::En, "runtime_setup.item.uv") => Some("uv"),
        (Locale::En, "runtime_setup.item.python") => Some("Python + MCP packages"),
        (Locale::En, "runtime_setup.item.r") => Some("R + jsonlite"),
        (Locale::En, "runtime_setup.item.node") => Some("Node.js ≥ 20 + npm"),
        (Locale::En, "runtime_setup.item.sci") => Some("sci (scimaster-cli)"),
        (Locale::En, "runtime_setup.item.pixi") => Some("pixi"),
        (Locale::En, "runtime_setup.item.officecli") => Some("officecli"),
        (Locale::En, "runtime_setup.item.sci_key") => Some("SciMaster API key"),
        (Locale::En, "runtime_setup.status.pending") => Some("Not checked"),
        (Locale::En, "runtime_setup.status.ready") => Some("Ready"),
        (Locale::En, "runtime_setup.status.installing") => Some("Installing"),
        (Locale::En, "runtime_setup.status.passed") => Some("Passed"),
        (Locale::En, "runtime_setup.status.failed") => Some("Failed"),
        (Locale::En, "runtime_setup.status.needs_user") => Some("Needs a key"),
        (Locale::En, "runtime_setup.sci_key_placeholder") => Some("Paste SciMaster API key (optional)"),
        (Locale::En, "runtime_setup.sci_key_save") => Some("Save key"),
        (Locale::En, "runtime_setup.preparing") => Some("Environment is still being prepared. Open the setup chip to watch progress."),
...
Do not leave generated files in the project root.",
        ...
        (Locale::Zh, "models.advanced") => Some("高级设置"),
        ...
        (Locale::Zh, "models.reuse_key") => Some("将使用 {host} 上已保存的密钥，留空即可复用。"),
        ...
        (Locale::Zh, "models.add_provider_title") => Some("添加自定义提供商"),
        (Locale::Zh, "models.edit_provider_title") => Some("{name} — 模型管理"),
        (Locale::Zh, "models.tag.custom") => Some("自定义"),
        (Locale::Zh, "models.status.live") => Some("Live"),
        (Locale::Zh, "models.field.endpoint") => Some("ENDPOINT"),
        (Locale::Zh, "models.field.api_key_short") => Some("API KEY"),
        (Locale::Zh, "models.field.models") => Some("MODELS"),
        (Locale::Zh, "models.count") => Some("{n} 个模型"),
        (Locale::Zh, "models.modify_key") => Some("修改"),
        (Locale::Zh, "models.card.models") => Some("模型"),
        ...
        (Locale::Zh, "share.image_footer") => Some("来自天成科研助手的分享"),
        ...
        (Locale::Zh, "review.transition_to_reviewer") => Some("天成科研助手拍了拍 Reviewer：帮我检查一下这次回答"),
        (Locale::Zh, "review.transition_to_agent") => Some("Reviewer 拍了拍天成科研助手：发现问题，请接着修正"),
        (Locale::Zh, "review.transition_passed") => Some("Reviewer 拍了拍天成科研助手：没发现问题，请继续"),
        ...
        (Locale::Zh, "settings.storage.data_dir_hint") => {
            Some("天成科研助手在本机保存数据库、Python 环境和插件的位置")
        }
        ...
        (Locale::Zh, "chat.assistant") => Some("天成科研助手"),
        ...
        (Locale::Zh, "caps.tile.env_setup.blurb") => Some("检查并准备本机 Python、R、Node、sci、pixi、officecli。"),
        ...
        (Locale::Zh, "runtime_setup.title") => Some("准备本机环境"),
        (Locale::Zh, "runtime_setup.why") => Some("分析、出图、文献、Office 和内置生物库都依赖本机工具，安装包不会预装。这一步在后台检查并下载缺失项，可以边用边装。"),
        (Locale::Zh, "runtime_setup.scope") => Some("会装 uv/Python、R 内核、Node/sci、pixi、officecli。不覆盖已有 R，不预装 Seurat，也不替你注册 SciMaster。密钥可以后填。"),
        (Locale::Zh, "runtime_setup.skip_hint") => Some("跳过就能立刻用应用；缺的能力稍后在「配置本机环境」补。收起不等于跳过，安装会继续。"),
        (Locale::Zh, "runtime_setup.start") => Some("开始准备"),
        (Locale::Zh, "runtime_setup.skip") => Some("稍后再说"),
        (Locale::Zh, "runtime_setup.cancel") => Some("取消安装"),
        (Locale::Zh, "runtime_setup.collapse") => Some("收起"),
        (Locale::Zh, "runtime_setup.expand") => Some("展开准备"),
        (Locale::Zh, "runtime_setup.chip.preparing") => Some("正在准备环境 {done}/{total}"),
        (Locale::Zh, "runtime_setup.chip.ready") => Some("环境已就绪"),
        (Locale::Zh, "runtime_setup.chip.incomplete") => Some("环境未就绪"),
        (Locale::Zh, "runtime_setup.item.uv") => Some("uv"),
        (Locale::Zh, "runtime_setup.item.python") => Some("Python + MCP 依赖"),
        (Locale::Zh, "runtime_setup.item.r") => Some("R + jsonlite"),
        (Locale::Zh, "runtime_setup.item.node") => Some("Node.js ≥ 20 + npm"),
        (Locale::Zh, "runtime_setup.item.sci") => Some("sci（scimaster-cli）"),
        (Locale::Zh, "runtime_setup.item.pixi") => Some("pixi"),
        (Locale::Zh, "runtime_setup.item.officecli") => Some("officecli"),
        (Locale::Zh, "runtime_setup.item.sci_key") => Some("SciMaster API 密钥"),
        (Locale::Zh, "runtime_setup.status.pending") => Some("未检测"),
        (Locale::Zh, "runtime_setup.status.ready") => Some("就绪"),
        (Locale::Zh, "runtime_setup.status.installing") => Some("安装中"),
        (Locale::Zh, "runtime_setup.status.passed") => Some("通过"),
        (Locale::Zh, "runtime_setup.status.failed") => Some("失败"),
        (Locale::Zh, "runtime_setup.status.needs_user") => Some("待填写"),
        (Locale::Zh, "runtime_setup.sci_key_placeholder") => Some("粘贴 SciMaster API 密钥（可选）"),
        (Locale::Zh, "runtime_setup.sci_key_save") => Some("保存密钥"),
        (Locale::Zh, "runtime_setup.preparing") => Some("环境仍在准备。点右下角芯片可看进度。"),
