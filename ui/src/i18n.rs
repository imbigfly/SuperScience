...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "settings.nav.files") => Some("Files"),
        ...
        (Locale::En, "composer.hint") => Some("Enter to send · Shift+Enter for newline · Drag top edge to resize · Drop or paste files to attach"),
        (Locale::En, "composer.hint_modifier") => Some("{modifier}+Enter to send · Enter for newline · Drag top edge to resize · Drop or paste files to attach"),
        ...
        (Locale::En, "full_permission.confirm_body") => Some("SuperScience will automatically approve tool calls, dangerous commands, and ACP permission requests in this conversation until you turn this off or restart the app. Project path restrictions and explicit blocked-tool rules still apply."),
        ...
        (Locale::En, "models.empty") => Some("Add a provider to connect an API, or use quick setup below."),
        (Locale::En, "providers.add") => Some("Add provider"),
        (Locale::En, "providers.settings") => Some("Settings"),
        (Locale::En, "providers.models") => Some("Models"),
        (Locale::En, "providers.remove") => Some("Remove"),
        (Locale::En, "providers.remove_confirm") => Some("Remove provider \"{provider}\"? This cannot be undone."),
        (Locale::En, "providers.badge.builtin") => Some("Live"),
        (Locale::En, "providers.badge.custom") => Some("Custom"),
        (Locale::En, "providers.endpoint") => Some("Endpoint"),
        (Locale::En, "providers.api_key") => Some("API key"),
        (Locale::En, "providers.model_count") => Some("{n} models"),
        (Locale::En, "providers.add_title") => Some("Add provider"),
        (Locale::En, "providers.edit_title") => Some("Provider settings"),
        (Locale::En, "providers.cannot_remove_builtin") => Some("Built-in providers cannot be removed."),
        (Locale::En, "providers.remove_has_models") => Some("Remove or move all models under this provider first."),
        (Locale::En, "providers.clear_key") => Some("Clear stored key"),
        (Locale::En, "providers.edit_key") => Some("Edit"),
        (Locale::En, "providers.key_missing") => Some("Missing"),
        (Locale::En, "providers.preset_needs_key") => Some("Save an API key for this provider to add the preset model."),
        (Locale::En, "providers.search_models") => Some("Search models…"),
        ...
        (Locale::En, "composer.cmd_share_sub") => Some("Export selected messages as a shareable PNG image"),
        ...
        (Locale::En, "review.transition_to_reviewer") => Some("superscience nudged Reviewer: please check this response"),
        (Locale::En, "review.transition_to_agent") => Some("Reviewer nudged superscience: findings found, please revise"),
        (Locale::En, "review.transition_passed") => Some("Reviewer nudged superscience: no issues found, please continue"),
        ...
        (Locale::En, "hosts.auth_password") => Some("Password (stored in local secrets file)"),
        ...
        (Locale::En, "hosts.password_hint") => Some("The password is stored only in the local secrets file — never in project files or SQLite. Prefer SSH keys when possible."),
        ...
        (Locale::En, "agents.roundtable.profile_hint") => Some("Native may choose a SuperScience model. ACP model and reasoning settings come from that Agent profile."),
        ...
        (Locale::En, "graph.subtitle") => Some(
            "Turn this project's data, papers, artifacts, and decisions into a relationship map—so you can later see why you did what you did.",
        ),
        (Locale::En, "publication.title") => Some("Publication Workspace"),
        (Locale::En, "publication.subtitle") => Some(
            "For one manuscript revision, pick the small set of exact evidence that supports the paper, freeze it, and optionally build a verifiable evidence capsule.",
        ),
        ...
        (Locale::En, "right.no_artifacts.body") => Some("Markdown tables, CSV blocks, equations, and file previews from superscience appear here."),
        ...
        (Locale::En, "ssh_check.body") => Some("SuperScience will not let the agent use `{host}` until connectivity is confirmed with a successful Probe using the configured host settings (alias/user/port/identity). Free-form shell ssh is disabled."),
        ...
        (Locale::En, "ssh_check.probe_output_body") => Some("SSH authentication to `{host}` succeeded, but the account did not execute SuperScience's non-interactive probe commands. Remote command execution is required for Agent, Runtime, Files, and terminal features."),
        ...
        (Locale::En, "ssh_check.cause.auth.4") => Some("Password wrong / not saved in the local secrets file, or the server rejected password login for this user."),
        ...
        (Locale::En, "runtime_config.scope") => Some("Saved in SuperScience for execution context {context}."),
        ...
        (Locale::En, "approval.hint") => Some("Approve to run this once. Change default behavior in Settings → MCP Connections."),
        (Locale::En, "approval.image_resize_title") => Some("Resize large image for model input?"),
        (Locale::En, "approval.image_resize_hint") => Some("SuperScience will resize a temporary model-input copy. The original file will not be changed."),
        ...
        (Locale::En, "approval.resource_conflict_hint") => Some("SuperScience will keep the current operation paused and continue it only after the conflicting call releases the resource."),
        ...
        (Locale::En, "appearance.light") => Some("Day"),
        (Locale::En, "appearance.dark") => Some("Night"),
        (Locale::En, "appearance.light_theme") => Some("Day theme"),
        (Locale::En, "appearance.dark_theme") => Some("Night theme"),
        (Locale::En, "appearance.toggle_to_light") => Some("Switch to day mode"),
        (Locale::En, "appearance.toggle_to_dark") => Some("Switch to night mode"),
        ...
        (Locale::En, "settings.nav.connections") => Some("MCP Connections"),
        (Locale::En, "settings.nav.channels") => Some("Channel Access"),
        (Locale::En, "channels.desc") => Some("Connect Feishu, WeChat, or a StickS3 device to SuperScience. Each channel stays opt-in and has its own security boundary."),
        ...
        (Locale::En, "channels.secret_note") => Some("Secrets are stored in the local secrets file."),
        (Locale::En, "channels.saved") => Some("Channel access settings saved."),
        (Locale::En, "channels.open") => Some("Configure"),
        ...
        (Locale::En, "channels.device.token_stored") => Some("A token is stored in the local secrets file."),
        ...
        (Locale::En, "settings.storage.data_dir_hint") => {
            Some("Where superscience keeps its database, Python environment and plugins on this machine")
        }
        ...
        (Locale::En, "settings.usage.total") => Some("Total tokens"),
        (Locale::En, "settings.usage.legend_less") => Some("Less"),
        (Locale::En, "settings.usage.legend_more") => Some("More"),
        (Locale::En, "settings.usage.session_list") => Some("Sessions"),
        (Locale::En, "settings.usage.session_list_hint") => Some("Token usage by conversation in this workspace"),
        ...
        (Locale::En, "environments.trust_managed") => Some("SSH trust, key installed by SuperScience"),
        ...
        (Locale::En, "cred.desc") => Some("API keys for external services used by skills and tools — including your own custom entries — are stored in the local secrets file."),
        ...
        (Locale::En, "cred.openalex.unconfigured") => Some("SuperScience falls back to anonymous OpenAlex requests. Literature tools can still work, but with a tighter quota and a higher chance of rate limiting."),
        ...
        (Locale::En, "cred.infinisynapse.configured") => Some("SuperScience initializes agent_infini so supported database and RAG analysis workflows can authenticate."),
        (Locale::En, "cred.infinisynapse.unconfigured") => Some("InfiniSynapse workflows remain unavailable. Unrelated SuperScience tools continue to work."),
        ...
        (Locale::En, "cred.scimaster.unconfigured") => Some("Workflows that require authenticated SCIMaster search cannot run. Unrelated SuperScience tools continue to work."),
        ...
        (Locale::En, "cred.ncbi.configured") => Some("An API key raises the E-utilities rate limit from 3 to 10 requests/s. A contact email identifies SuperScience's requests to NCBI."),
        ...
        (Locale::En, "settings.api_key") => Some("API key (stored in local secrets file)"),
        ...
        (Locale::En, "settings.auto_compact_hint") => Some("Enabled by default. Before each model call, SuperScience archives and compacts the conversation when its estimated context reaches 80%."),
        ...
        (Locale::En, "settings.resume_last_session_hint") => Some("Enabled by default. Open the most recently active conversation instead of a blank new conversation."),
        ...
        (Locale::En, "settings.sync.relay_hint") => Some("Stored in the local secrets file; it is never included in project data or device codes."),
        ...
        (Locale::En, "settings.image_generation_hint") => Some("Currently supports OpenAI gpt-image-2 for PNG output. Explicit SVG requests use the direct-SVG preview-and-correct path. With no format requested, a configured image model creates PNG; otherwise the Illustrator delivers SVG."),
        (Locale::En, "settings.stored_key") => Some("(stored — leave blank to keep)"),
        (Locale::En, "settings.tip") => Some("Enter the provider's API base URL. You do not need to append /v1, /chat/completions, /responses, or /v1/messages; SuperScience completes the request path and probes common OpenAI-compatible paths automatically."),
        ...
        (Locale::En, "status.up_to_date") => Some("SuperScience is up to date (v{version})."),
        ...
        (Locale::En, "update_modal.available_body") => Some("SuperScience {version} is available."),
        (Locale::En, "update_modal.download") => Some("Download update"),
        (Locale::En, "update_modal.downloading_title") => Some("Downloading SuperScience {version}"),
        (Locale::En, "update_modal.downloading_body") => Some("Downloading the signed update. Keep SuperScience open until verification finishes."),
        (Locale::En, "update_modal.ready_title") => Some("Ready to install"),
        (Locale::En, "update_modal.ready_body") => Some("SuperScience {version} has been downloaded and its signature verified. Installing will restart SuperScience."),
        (Locale::En, "update_modal.install") => Some("Install and restart"),
        (Locale::En, "update_modal.installing_title") => Some("Installing SuperScience {version}"),
        (Locale::En, "update_modal.installing_body") => Some("Installing the verified update and restarting SuperScience…"),
        (Locale::En, "update_modal.up_to_date_title") => Some("You're up to date"),
        (Locale::En, "update_modal.up_to_date_body") => Some("SuperScience {version} is already the latest version."),
        (Locale::En, "update_modal.failed_title") => Some("Couldn't update SuperScience"),
        ...
        (Locale::En, "chat.assistant") => Some("superscience"),
        ...
        (Locale::En, "chat.model_wait_1") => Some("AI is trying to think…"),
        (Locale::En, "chat.model_wait_2") => Some("AI is Analyzing the problem…"),
        (Locale::En, "chat.model_wait_3") => Some("AI is about to finish its calculation, and the answer is about to emerge…"),
        (Locale::En, "chat.model_wait_4") => Some("AI is deciding what to do next…"),
        ...
        (Locale::En, "context_recovery.body") => Some("The model rejected the request because the conversation exceeded its context window. Choose how SuperScience should preserve and continue the work."),
        ...
        (Locale::En, "caps.group.paper_writing") => Some("Paper writing"),
        (Locale::En, "caps.group.ai_drawing") => Some("AI drawing"),
        (Locale::En, "caps.group.data_cleaning") => Some("Data cleaning"),
        (Locale::En, "caps.group.stats") => Some("Statistical analysis"),
        ...
        (Locale::En, "caps.tile.ai_mechanism_figure.blurb") => {
            Some("Draw top-journal–style mechanism figures with AI.")
        }
        (Locale::En, "caps.tile.editable_figure.title") => Some("Editable figure"),
        (Locale::En, "caps.tile.editable_figure.blurb") => {
            Some("Convert mechanism figures into an editable format.")
        }
        (Locale::En, "caps.tile.bioinfo_figure_layout.title") => Some("Bioinformatics figure layout"),
        (Locale::En, "caps.tile.bioinfo_figure_layout.blurb") => {
            Some("Hand the Agent a pile of bioinformatics plots; get a submission-ready layout.")
        }
        ...
        (Locale::En, "caps.tile.data_cleaning.blurb") => Some("Import tables, fix types/missing values, and produce analysis-ready datasets."),
        (Locale::En, "caps.tile.pii_firewall.title") => Some("PII outbound firewall"),
        (Locale::En, "caps.tile.pii_firewall.blurb") => Some("Detect and pseudonymize emails, phones, and IDs before they reach the cloud model; restore them in replies."),
        ...
        (Locale::En, "caps.tile.pii_firewall.modal_what_1") => Some("Stops emails, phone numbers, ID numbers, and similar personal data from being sent to the cloud model in plain text."),
        ...
        (Locale::En, "caps.skill.academic_paper_reviewer.title") => Some("Multi-reviewer critique"),
        ...
        (Locale::En, "caps.skill.nature_reviewer.title") => Some("Pre-submission peer review"),
        ...
        (Locale::En, "caps.skill.knowledge_graph.blurb") => Some(
            "Extract entity relations from a paper or notes and build an interactive graph.",
        ),
        ...
        (Locale::En, "caps.prompt.data_cleaning") => Some(
            "Help me clean and reshape research data. Get language preference if needed, then ask me to upload/attach the table or give a project path—do not ask row/column counts. As soon as the file is available, inspect it in the Python/R REPL and deliver a cleaned analysis-ready dataset (or a clear first cleaning pass).",
        ),
        ...
        (Locale::En, "caps.prompt.python_r") => Some(
            "Help me analyze data with the persistent Python or R REPL. Ask for my analysis goal and the data file/path (upload preferred). Then start coding and deliver results—do not keep interviewing about file metadata.",
        ),
        ...
        (Locale::En, "onboard.card1.body") => Some("Everything runs on your computer — nothing is uploaded."),
        ...
        (Locale::En, "onboard.apikey.body") => Some("Paste it here. This sets up deepseek-v4-flash as the default, plus deepseek-v4-pro for heavier work — switch between them per session. Keys are stored in the local secrets file, not in the project folder. Other providers (OpenAI, Anthropic, …) can be added anytime in Settings › Models."),
        (Locale::En, "onboard.apikey.get_key") => Some("Open the DeepSeek console →"),
        (Locale::En, "onboard.apikey.later") => Some("Set up later"),
        (Locale::En, "onboard.features.title") => Some("What 天成科研助手 can do"),
        ...
        (Locale::En, "command.scratch") => Some("Start conversation"),
        (Locale::En, "scratch.title") => Some("Start conversation"),
        (Locale::En, "scratch.open") => Some("Start conversation"),
        (Locale::En, "scratch.close") => Some("Close conversation"),
        ...
        (Locale::En, "command.theme_light") => Some("Day mode"),
        (Locale::En, "command.theme_dark") => Some("Night mode"),
        ...
        (Locale::En, "projects.import_options_hint") => Some("Choose whether to use an existing folder in place or restore a complete project archive."),
        (Locale::En, "projects.import_in_place") => Some("Open a folder in place"),
        (Locale::En, "projects.import_in_place_hint") => Some("Keep every file where it is. project registers the folder without copying it."),
        (Locale::En, "projects.import_zip") => Some("Import a ZIP archive"),
        (Locale::En, "projects.import_zip_hint") => Some("Restore workspace files, conversations, and project records into a new folder."),
        (Locale::En, "projects.open_folder_title") => Some("Open project folder"),
        (Locale::En, "projects.open_folder_hint") => Some("project will use this folder in place. No project files are copied."),
        ...
        (Locale::En, "projects.transfer.selecting_import_destination") => Some("Choose a parent folder. SuperScience will create a new folder named after the imported project inside it."),
        ...
        (Locale::En, "projects.sync.code_placeholder") => Some("superscience-sync:…"),
...
Do not leave generated files in the project root.",
        ...
        (Locale::En, "projects.remove_only") => Some("Remove from SuperScience only"),
        ...
        (Locale::En, "err.project_delete_workspace_empty") => Some("The project directory is empty, so SuperScience refused to delete local data."),
        (Locale::En, "err.project_delete_root") => Some("SuperScience refused to delete a filesystem root."),
        (Locale::En, "projects.open_failed") => Some("Could not open the project: {msg}"),
        (Locale::En, "projects.star_hint") => Some("If 天成科研助手 is helpful to your work, please"),
        ...
        (Locale::Zh, "settings.nav.files") => Some("文件"),
        ...
        (Locale::Zh, "composer.hint") => Some("Enter 发送 · Shift+Enter 换行 · 拖拽上边缘调整高度 · 拖放或粘贴文件可附加"),
        (Locale::Zh, "composer.hint_modifier") => Some("{modifier}+Enter 发送 · Enter 换行 · 拖拽上边缘调整高度 · 拖放或粘贴文件可附加"),
        ...
        (Locale::Zh, "models.empty") => Some("添加服务商以连接 API，或使用下方快速配置。"),
        (Locale::Zh, "providers.add") => Some("添加服务商"),
        (Locale::Zh, "providers.settings") => Some("设置"),
        (Locale::Zh, "providers.models") => Some("模型"),
        (Locale::Zh, "providers.remove") => Some("删除"),
        (Locale::Zh, "providers.remove_confirm") => Some("确定删除服务商“{provider}”吗？此操作无法撤销。"),
        (Locale::Zh, "providers.badge.builtin") => Some("内置"),
        (Locale::Zh, "providers.badge.custom") => Some("自定义"),
        (Locale::Zh, "providers.endpoint") => Some("接口地址"),
        (Locale::Zh, "providers.api_key") => Some("API 密钥"),
        (Locale::Zh, "providers.model_count") => Some("{n} 个模型"),
        (Locale::Zh, "providers.add_title") => Some("添加服务商"),
        (Locale::Zh, "providers.edit_title") => Some("服务商设置"),
        (Locale::Zh, "providers.cannot_remove_builtin") => Some("内置服务商无法删除。"),
        (Locale::Zh, "providers.remove_has_models") => Some("请先删除或移走该服务商下的所有模型。"),
        (Locale::Zh, "providers.clear_key") => Some("撤销密钥"),
        (Locale::Zh, "providers.edit_key") => Some("修改"),
        (Locale::Zh, "providers.key_missing") => Some("未配置"),
        (Locale::Zh, "providers.preset_needs_key") => Some("请先为该服务商保存 API 密钥，再添加预设模型。"),
        (Locale::Zh, "providers.search_models") => Some("搜索模型…"),
        ...
        (Locale::Zh, "composer.cmd_share_sub") => Some("把选中的对话导出为可分享的长图"),
        ...
        (Locale::Zh, "review.transition_to_reviewer") => Some("superscience 拍了拍 Reviewer：帮我检查一下这次回答"),
        (Locale::Zh, "review.transition_to_agent") => Some("Reviewer 拍了拍 superscience：发现问题，请接着修正"),
        (Locale::Zh, "review.transition_passed") => Some("Reviewer 拍了拍 superscience：没发现问题，请继续"),
        ...
        (Locale::Zh, "hosts.auth_password") => Some("密码（存入本地密钥文件）"),
        (Locale::Zh, "hosts.password") => Some("密码"),
        (Locale::Zh, "hosts.password_ph") => Some("服务器登录密码"),
        (Locale::Zh, "hosts.password_keep") => Some("留空则保留已保存的密码"),
        (Locale::Zh, "hosts.password_hint") => Some("密码只保存在本地密钥文件中，不会写入项目文件或 SQLite。能用密钥时优先用密钥。"),
        ...
        (Locale::Zh, "agents.roundtable.profile_hint") => Some("Native 可选择 SuperScience 模型；ACP 的模型和思考强度来自对应 Agent 配置。"),
        ...
        (Locale::Zh, "graph.subtitle") => Some(
            "把项目里「数据、文献、产物、你做过的判断」记成一张关系网，方便以后回看「为什么这么做」。",
        ),
        (Locale::Zh, "publication.title") => Some("论文证据工作区"),
        (Locale::Zh, "publication.subtitle") => Some(
            "为某一篇手稿的某一版，挑出「支撑这篇稿子的那一小撮精确证据」，冻结起来，必要时打成可核查的「证据胶囊」。",
        ),
        ...
        (Locale::Zh, "ssh_check.body") => Some("在使用配置的主机参数（别名/用户/端口/密钥）成功探测之前，SuperScience 不会让 Agent 访问 `{host}`。已禁用 shell 里自由拼装的 ssh 命令。"),
        (Locale::Zh, "ssh_check.fail_body") => Some("在修好问题之前，请不要对 `{host}` 反复探测——连续失败登录会被当成爆破，可能封禁你的 IP。"),
        (Locale::Zh, "ssh_check.probe_output_body") => Some("SuperScience 已通过 `{host}` 的 SSH 认证，但该账号没有执行非交互探测命令。Agent、Runtime、Files 和终端功能都需要远程命令执行能力。"),
        ...
        (Locale::Zh, "ssh_check.cause.auth.4") => Some("密码错误/未保存到本地密钥文件，或服务器拒绝该用户密码登录。"),
        ...
        (Locale::Zh, "runtime_config.scope") => Some("保存在 SuperScience 的执行环境 {context} 中。"),
        ...
        (Locale::Zh, "approval.hint") => Some("批准后执行一次。默认策略可在「设置 → MCP连接」中修改。"),
        (Locale::Zh, "approval.image_resize_title") => Some("缩小大图片后交给模型？"),
        (Locale::Zh, "approval.image_resize_hint") => Some("SuperScience 只会缩小临时的模型输入副本，原始文件不会被修改。"),
        ...
        (Locale::Zh, "approval.resource_conflict_hint") => Some("SuperScience 会暂停当前操作，等冲突调用释放资源后再继续。"),
        ...
        (Locale::Zh, "appearance.system") => Some("跟随系统"),
        (Locale::Zh, "appearance.light") => Some("白天"),
        (Locale::Zh, "appearance.dark") => Some("黑夜"),
        (Locale::Zh, "appearance.light_theme") => Some("白天主题"),
        (Locale::Zh, "appearance.dark_theme") => Some("黑夜主题"),
        (Locale::Zh, "appearance.toggle_to_light") => Some("切换到白天模式"),
        (Locale::Zh, "appearance.toggle_to_dark") => Some("切换到黑夜模式"),
        ...
        (Locale::Zh, "settings.nav.connections") => Some("MCP连接"),
        (Locale::Zh, "settings.nav.channels") => Some("频道接入"),
        (Locale::Zh, "channels.desc") => Some("将飞书、微信或 StickS3 设备接入 SuperScience。每种频道接入都默认关闭，并具有独立的安全边界。"),
        (Locale::Zh, "channels.routing.desc") => Some("对于 IM 机器人，首条消息会在桌面端当前项目创建会话。之后该 IM 对话会固定连接到同一个项目和会话，直到使用 slash command 主动切换。"),
        (Locale::Zh, "channels.secret_note") => Some("密钥只保存在本地密钥文件中。"),
        (Locale::Zh, "channels.saved") => Some("频道接入设置已保存。"),
        (Locale::Zh, "channels.open") => Some("配置"),
        ...
        (Locale::Zh, "channels.device.token_stored") => Some("令牌已保存在本地密钥文件中。"),
        ...
        (Locale::Zh, "settings.storage.data_dir_hint") => {
            Some("superscience 在本机保存数据库、Python 环境和插件的位置")
        }
        ...
        (Locale::Zh, "settings.usage.total") => Some("合计 Token"),
        (Locale::Zh, "settings.usage.legend_less") => Some("少"),
        (Locale::Zh, "settings.usage.legend_more") => Some("多"),
        (Locale::Zh, "settings.usage.session_list") => Some("会话明细"),
        (Locale::Zh, "settings.usage.session_list_hint") => Some("本工作区各会话的 token 用量"),
        ...
        (Locale::Zh, "environments.trust_managed") => Some("SSH 信任，由 SuperScience 安装的密钥"),
        ...
        (Locale::Zh, "cred.desc") => Some("技能与工具所用外部服务的 API 密钥（包括自定义凭据）均保存在本地密钥文件中。"),
        ...
        (Locale::Zh, "cred.openalex.about") => Some("开放的学术成果、作者、机构、来源和引用目录，SuperScience 的文献工具会使用它。"),
        (Locale::Zh, "cred.openalex.configured") => Some("请求会通过身份验证，访问更稳定，也更不容易因 OpenAlex 限流而中断。"),
        (Locale::Zh, "cred.openalex.unconfigured") => Some("SuperScience 会改用 OpenAlex 匿名请求。文献工具仍可工作，但额度更低，更容易触发限流。"),
        ...
        (Locale::Zh, "cred.infinisynapse.configured") => Some("SuperScience 会初始化 agent_infini，让支持的数据库和 RAG 分析工作流能够认证。"),
        (Locale::Zh, "cred.infinisynapse.unconfigured") => Some("InfiniSynapse 相关工作流不可用；SuperScience 的其他工具仍可正常使用。"),
        ...
        (Locale::Zh, "cred.scimaster.about") => Some("一项科学文献检索服务，SuperScience 内置的 bear-* 研究技能和 sci CLI 会使用它。"),
        (Locale::Zh, "cred.scimaster.configured") => Some("sci search、MCP 调用和 bear-* 工作流可以通过认证执行真实文献检索。"),
        (Locale::Zh, "cred.scimaster.unconfigured") => Some("需要 SCIMaster 认证检索的工作流无法运行；SuperScience 的其他工具仍可正常使用。"),
        ...
        (Locale::Zh, "cred.ncbi.configured") => Some("API 密钥可将 E-utilities 限速从每秒 3 次提升到 10 次；联系邮箱用于向 NCBI 标识 SuperScience 的请求。"),
        ...
        (Locale::Zh, "settings.api_key") => Some("API 密钥（保存在本地密钥文件）"),
        ...
        (Locale::Zh, "settings.auto_compact_hint") => Some("默认开启。每次模型调用前，当预估上下文达到 80% 时，SuperScience 会先归档完整对话，再自动压缩。"),
        ...
        (Locale::Zh, "settings.resume_last_session_hint") => Some("默认开启。打开工作区时恢复最近活跃的会话，而不是直接进入空白新对话。"),
        ...
        (Locale::Zh, "settings.sync.relay_hint") => Some("令牌保存在本地密钥文件中，不会写入项目数据或设备码。"),
        ...
        (Locale::Zh, "settings.image_generation_hint") => Some("目前仅支持 OpenAI gpt-image-2 生成 PNG。明确要求 SVG 时走直接生成、预览并修正 SVG 的路径；未指定格式时，有生图模型则生成 PNG，否则交付 SVG。"),
        (Locale::Zh, "settings.stored_key") => Some("（已保存 — 留空则保持不变）"),
        (Locale::Zh, "settings.tip") => Some("请填写服务商提供的 API 基础地址；无需手动追加 /v1、/chat/completions、/responses 或 /v1/messages，SuperScience 会自动补全请求路径，并探测常见的 OpenAI 兼容路径。"),
        ...
        (Locale::Zh, "status.up_to_date") => Some("SuperScience 已是最新版本（v{version}）。"),
        ...
        (Locale::Zh, "update_modal.available_body") => Some("SuperScience {version} 已可用。"),
        (Locale::Zh, "update_modal.download") => Some("下载更新"),
        (Locale::Zh, "update_modal.downloading_title") => Some("正在下载 SuperScience {version}"),
        (Locale::Zh, "update_modal.downloading_body") => Some("正在下载已签名的更新。请保持 SuperScience 打开，直到校验完成。"),
        (Locale::Zh, "update_modal.ready_title") => Some("可以安装"),
        (Locale::Zh, "update_modal.ready_body") => Some("SuperScience {version} 已下载并通过签名校验。安装将重启 SuperScience。"),
        (Locale::Zh, "update_modal.install") => Some("安装并重启"),
        (Locale::Zh, "update_modal.installing_title") => Some("正在安装 SuperScience {version}"),
        (Locale::Zh, "update_modal.installing_body") => Some("正在安装已校验的更新并重启 SuperScience…"),
        (Locale::Zh, "update_modal.up_to_date_title") => Some("已是最新版本"),
        (Locale::Zh, "update_modal.up_to_date_body") => Some("SuperScience {version} 已经是最新版本。"),
        (Locale::Zh, "update_modal.failed_title") => Some("无法更新 SuperScience"),
        ...
        (Locale::Zh, "chat.assistant") => Some("superscience"),
        ...
        (Locale::Zh, "chat.model_wait_1") => Some("AI正努力思考…"),
        (Locale::Zh, "chat.model_wait_2") => Some("AI正在分析问题…"),
        (Locale::Zh, "chat.model_wait_3") => Some("AI马上思考完毕，答案即将浮出水面…"),
        (Locale::Zh, "chat.model_wait_4") => Some("AI正在决定下一步怎么做…"),
        ...
        (Locale::Zh, "caps.tile.ai_mechanism_figure.blurb") => {
            Some("通过AI来绘制顶刊配色的机制图")
        }
        ...
        (Locale::Zh, "caps.tile.bioinfo_figure_layout.blurb") => {
            Some("把一堆生信图丢给Agent，自动输出符合投稿要求的布局排版图")
        }
        ...
        (Locale::Zh, "caps.tile.data_cleaning.blurb") => Some("导入表格、处理缺失与类型问题，产出可分析数据集。"),
        (Locale::Zh, "caps.tile.pii_firewall.title") => Some("出站隐私脱敏"),
        (Locale::Zh, "caps.tile.pii_firewall.blurb") => Some("在发往云端模型前检测并假名化邮箱、手机号、身份证等；回复时再还原，不打断对话上下文。"),
        ...
        (Locale::Zh, "caps.tile.pii_firewall.modal_what_1") => Some("避免邮箱、手机号、身份证号等个人信息以明文形式发给云端模型。"),
        ...
        (Locale::Zh, "caps.skill.academic_paper_reviewer.title") => Some("多角色审稿"),
        ...
        (Locale::Zh, "caps.skill.nature_reviewer.title") => Some("投稿前模拟审稿"),
        ...
        (Locale::Zh, "caps.prompt.data_cleaning") => Some(
            "请帮我清洗并整理研究数据。如需再问语言偏好，然后请我上传/附加表格或给出项目路径——不要问行列数。文件一到手，立刻用 Python/R REPL 检查，并交付一份可分析的清洗结果（或明确的第一轮清洗产出）。",
        ),
        ...
        (Locale::Zh, "caps.prompt.python_r") => Some(
            "请用本项目的持久 Python 或 R REPL 帮我分析数据。先问清分析目标，并请我提供数据文件/路径（优先上传）。然后直接写代码并交付结果——不要继续盘问文件元数据。",
        ),
        ...
        (Locale::Zh, "caps.env_setup_prompt") => Some(
            "能力面板显示缺少运行时工具。请先 use_skill 加载 local-env-setup，按该 skill 为我的系统配置：(1) uv + Python（superscience 引导），(2) Node >= 20 + `npm install -g scimaster-cli` + `sci init`（bear-* 文献技能），(3) pixi（本地生信多环境分析）。验证能力面板并告知何时重启 superscience。",
        ),
        ...
        (Locale::Zh, "onboard.card1.body") => Some("所有处理在您的电脑上完成，绝不联网上传。"),
        (Locale::Zh, "onboard.card2.title") => Some("我只干脏活累活。"),
        (Locale::Zh, "onboard.card2.body") => Some("从模糊的 PDF/Word 里扒数据、纠错别字、理时间线。您负责思考科学问题，我负责敲键盘。"),
        ...
        (Locale::Zh, "onboard.apikey.body") => Some("把密钥粘贴到这里。会配好默认的 deepseek-v4-flash，以及更贵的 deepseek-v4-pro（适合更重的活），每个会话可随时切换。密钥只保存在本地密钥文件中，不会写入项目文件夹。其他模型（OpenAI、Anthropic 等）随时可在「设置 › 模型」里添加。"),
        (Locale::Zh, "onboard.apikey.get_key") => Some("打开 DeepSeek 控制台 →"),
        (Locale::Zh, "onboard.apikey.later") => Some("稍后配置"),
        (Locale::Zh, "onboard.features.title") => Some("天成科研助手能做什么"),
        ...
        (Locale::Zh, "command.scratch") => Some("开始对话"),
        (Locale::Zh, "scratch.title") => Some("开始对话"),
        (Locale::Zh, "scratch.open") => Some("开始对话"),
        (Locale::Zh, "scratch.close") => Some("关闭对话"),
        ...
        (Locale::Zh, "command.theme_light") => Some("白天模式"),
        (Locale::Zh, "command.theme_dark") => Some("黑夜模式"),
        ...
        (Locale::Zh, "projects.import_options_hint") => Some("请选择原地使用已有文件夹，或恢复一份完整的项目压缩包。"),
        (Locale::Zh, "projects.import_in_place") => Some("原地打开文件夹"),
        (Locale::Zh, "projects.import_in_place_hint") => Some("文件保持在当前位置；项目只登记此文件夹，不复制任何项目文件。"),
        (Locale::Zh, "projects.import_zip") => Some("导入 ZIP 压缩包"),
        (Locale::Zh, "projects.import_zip_hint") => Some("把工作区文件、会话和项目记录完整恢复到一个新文件夹。"),
        (Locale::Zh, "projects.open_folder_title") => Some("打开项目文件夹"),
        (Locale::Zh, "projects.open_folder_hint") => Some("项目会原地使用此文件夹，不会复制项目文件。"),
        ...
        (Locale::Zh, "projects.transfer.selecting_import_destination") => Some("请选择用于存放导入项目的父文件夹。SuperScience 会在其中新建一个与项目同名的文件夹。"),
        ...
        (Locale::Zh, "projects.sync.code_placeholder") => Some("superscience-sync:…"),
...
不要把生成的文件留在项目根目录。",
        ...
        (Locale::Zh, "projects.remove_only") => Some("仅从 SuperScience 移除"),
        ...
        (Locale::Zh, "err.project_delete_workspace_empty") => Some("项目目录为空，SuperScience 已拒绝删除本地数据。"),
        (Locale::Zh, "err.project_delete_root") => Some("SuperScience 已拒绝删除文件系统根目录。"),
        (Locale::Zh, "projects.open_failed") => Some("无法打开项目：{msg}"),
        (Locale::Zh, "projects.star_hint") => Some("如果天成科研助手对你的工作有帮助，欢迎到"),
...
pub fn localize_backend(locale: Locale, msg: &str) -> String {
    match msg {
        ...
        m if m.starts_with("SSH authentication succeeded, but the remote account did not execute") => {
            if locale == Locale::Zh {
                "SSH 认证已通过，但远程账号没有执行 SuperScience 的非交互探测命令。请检查受限 shell、强制命令或提前退出的登录启动脚本。".to_string()
            } else {
                msg.to_string()
            }
        }
...
/// `http: ...` from superscience-llm). Provider error bodies vary too much to parse,
