...
pub fn render_skill(skill: &Skill) -> String {
    ...
    // Skills may ship a `kernel.py` sidecar of python helpers. SuperScience has no
...
mod tests {
    ...
    // A kernel.py sidecar has no host auto-injection in SuperScience; the rendered
