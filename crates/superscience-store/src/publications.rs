...
async fn resolve_evidence_source(
    ...
    match kind {
        ...
        EvidenceSourceKind::MessageSpan => {
            ...
            let content = serde_json::from_str::<superscience_llm::Content>(&content_json)
        ...
        EvidenceSourceKind::ToolCall => {
            ...
            let calls = calls_json
                .as_deref()
                .and_then(|value| {
                    serde_json::from_str::<Vec<superscience_llm::ToolCall>>(value).ok()
                })
                .unwrap_or_default();
            let call = calls
                .iter()
            ...
            let result_text = serde_json::from_str::<superscience_llm::Content>(&result_json)
