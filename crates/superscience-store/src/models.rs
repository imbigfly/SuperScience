...
pub(crate) fn parse_role(s: &str) -> superscience_llm::Role {
    match s {
        "system" => superscience_llm::Role::System,
        "user" | "internal" => superscience_llm::Role::User,
        "assistant" => superscience_llm::Role::Assistant,
        "tool" => superscience_llm::Role::Tool,
        _ => superscience_llm::Role::User,
    }
}
