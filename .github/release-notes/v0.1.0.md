# SuperScience v0.1.0 — 早期测试版

这是 **superscience 的首个公开版本**，用于收集反馈、验证 Windows / macOS 桌面安装包与核心 agent 流程。**仍在积极测试中，不建议用于生产或关键科研任务。**
...
问题与建议请提交 [GitHub Issues](https://github.com/imbigfly/SuperScience/issues)。
