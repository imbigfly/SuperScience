...
**English:** superscience v0.19.0 replaces fixed Agent teams with dynamic, reviewable, persisted delegation. The main Agent can create capability-scoped Native or ACP workers, run dependency-aware tasks inline or in the background, delegate one bounded nested level, and isolate parallel writers in Git worktrees. Child conversations and model choices are now scoped to their owning conversation.
...
**Full Changelog:** https://github.com/imbigfly/SuperScience/compare/v0.18.0...v0.19.0
