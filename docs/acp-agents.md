...
6. If auth methods appear after the test, click the advertised button (for example browser login). Credentials stay with the agent; SuperScience does not store them in SQLite.
