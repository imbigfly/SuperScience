...
- **PR 4 screenshots were not captured here.** Dark theme and <960px behavior are covered by Playwright clamps and existing token-based styling. No new PNG baselines were added to `docs/design-qa/`.
