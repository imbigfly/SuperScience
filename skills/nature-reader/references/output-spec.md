...
- `reader.html` always, generated by `scripts/build_reader_html.py`
...
`reader.html` is the user-facing primary deliverable. `paper.md` remains the machine-readable companion and must expose paragraph-level bilingual alignment:
...
The companion `paper.md` should support:
...
Do not author this file by hand. After `source_map.json` is written, run:
...
The generated page should support:
