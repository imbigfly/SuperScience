...
rubric_ref: ../academic-shared/collaboration_depth_rubric.md
...
# ../academic-shared/collaboration_depth_rubric.md (agent behaviour vs rubric content).
version: "1.0.0"
---
...
The canonical rubric lives at `../academic-shared/collaboration_depth_rubric.md`. Read it before every scoring session — do not paraphrase or cache it. The rubric defines:
...
1. **Read the rubric fresh** from `../academic-shared/collaboration_depth_rubric.md`. Do not rely on memory of prior invocations.
...
Advisory only — your pipeline continues regardless. Full rubric: ../academic-shared/collaboration_depth_rubric.md
━━━
```
...
---
Rubric: ../academic-shared/collaboration_depth_rubric.md (version 1.0)
