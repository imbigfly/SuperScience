...
- Does not define `literature_corpus` entry shape (defined in [`../academic-shared/contracts/passport/literature_corpus_entry.schema.json`](../../shared/contracts/passport/literature_corpus_entry.schema.json) from v3.6.4+).
...
- [`../academic-shared/handoff_schemas.md`](../../shared/handoff_schemas.md) — Schema 9 definition
