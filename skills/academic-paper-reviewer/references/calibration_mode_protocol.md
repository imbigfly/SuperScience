...
`../academic-shared/cross_model_verification.md` § Calibration transport exception. Before
...
- `../academic-shared/cross_model_verification.md` — calibration transport and consent rules.
