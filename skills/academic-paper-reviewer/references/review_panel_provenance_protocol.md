...
- Input: `../academic-shared/contracts/reviewer/review_panel_provenance_input.schema.json`
- Output: `../academic-shared/contracts/reviewer/review_panel_provenance.schema.json`
- Schema 6 carrier: `../academic-shared/contracts/reviewer/review_panel_provenance_carrier.schema.json`
...
SHA-256 of the exact raw bytes of `../academic-shared/contracts/reviewer/full.json`. Its
