...
Finding severity is transported from the reviewer cards (the Schema 6 enum, `../academic-shared/handoff_schemas.md` § Weakness Object) — this table assigns NO severities (#574 A3); it describes how criterion judgements bear on the DECISION only.
