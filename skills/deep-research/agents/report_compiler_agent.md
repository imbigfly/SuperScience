...
- See `../academic-shared/style_calibration_protocol.md` for the full priority system
...
- Word budget uses whitespace-split convention (`body.split()`), not hyphenated-as-1. Reserve 3–5% buffer below hard cap. See `../academic-shared/references/word_count_conventions.md`.
- Compression must preserve protected hedging phrases identified by upstream calibration as budget-protected (the dispatch context carries the list). See `../academic-shared/references/protected_hedging_phrases.md`.
