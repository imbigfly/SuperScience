...
is `references/claim_standing_candidate_ledger_protocol.md`. This slice
...
`cross_model_verification.md`. Frozen design:
...
Schema: `sprint_contract.schema.json` (Schema 13).
...
1. Add the file under `contracts/<domain>/<mode>.json`.
...
`contracts/evidence/claim_registry.schema.json` (#737) is the closed E1
...
`contracts/evidence/evidence_row.schema.json` defines the closed
...
`contracts/evidence/evidence_row_v1_1.schema.json` is the separately
...
`contracts/evidence/evidence_row_v1_2.schema.json` is the separate closed
...
python scripts/resolve_human_subjects_authority.py \
  ...
  --registry human_subjects_authority_registry.json \
...
`references/human_subjects_authority_protocol.md`. Spec:
...
- `contracts/human_subjects/submission_packet_inventory.schema.json` — an author-declared
...
- `contracts/human_subjects/submission_packet_manifest.schema.json` — the pointer-only,
...
Protocol: `references/submission_packet_manifest_protocol.md`. Spec:
...
- `contracts/human_subjects/review_pathway_trace_request.schema.json`
...
- `contracts/human_subjects/review_pathway_rule_trace.schema.json`
...
`references/review_pathway_rule_trace_protocol.md`. Spec:
`docs/design/2026-08-11-669-review-pathway-rule-trace-spec.md`.

## Authority-profile content-coverage advisory (#681)

`contracts/human_subjects/content_coverage_advisory.schema.json` defines
...
Protocol:
`references/authority_content_coverage_advisory_protocol.md`. Spec:
...
Protocol: `references/cross_document_consistency_advisory_protocol.md`.
...
`review_criteria_registry.json` intentionally ships only a field-general
...
`references/review_criteria_consumer_protocol.md`. Frozen spec:
