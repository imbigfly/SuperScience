...
Supporting context (do not audit; reference only):
- contracts/passport/literature_corpus_entry.schema.json
...
- `references/irb_terminology_glossary.md` — referenced by dimension §3.5.
- `references/psychometric_terminology_glossary.md` — referenced by dimension §3.5.
- `references/protected_hedging_phrases.md` — referenced by Section 4(f) report_compiler bundle check (sub-checks ii + iii).
- `references/word_count_conventions.md` — referenced by Section 4(f) report_compiler bundle check (sub-check i).
