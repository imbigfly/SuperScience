...
- `references/human_subjects_authority_protocol.md` ([local protocol](human_subjects_authority_protocol.md)) — exact-selection, bounded-profile, pointer-only, and no-verdict contract.
