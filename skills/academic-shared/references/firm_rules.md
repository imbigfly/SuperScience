...
- `bibliographic_integrity_signals.md`, `deep-research/agents/ethics_review_agent.md`, and `docs/design/2026-08-08-651-retraction-status-spec.md` — R-L3-2-F.
...
- `contracts/passport/claim_intent_manifest.schema.json` — references `R-CIM-A` by ID in the `claims` field description.
