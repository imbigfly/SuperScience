...
- `contracts/evidence/evidence_row_v1_1.schema.json`
- `contracts/human_subjects/content_coverage_advisory.schema.json`
- `scripts/build_content_coverage_advisory.py`
- `references/submission_packet_manifest_protocol.md`
- `references/evidence_row_protocol.md`
...
`contracts/human_subjects/content_coverage_advisory.schema.json#/$defs/advisory_draft`,
