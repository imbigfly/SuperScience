...
field shape is `contracts/evidence/evidence_row.schema.json`; cross-field
...
`contracts/evidence/evidence_row_v1_1.schema.json` is a separate closed
...
`contracts/human_subjects/content_coverage_advisory.schema.json` and
`references/authority_content_coverage_advisory_protocol.md`. Their
...
`contracts/evidence/evidence_row_v1_2.schema.json` is a separate closed
...
`references/cross_document_consistency_advisory_protocol.md`.

## Version 1.3 claim-standing advisory surface (#655)

`contracts/evidence/evidence_row_v1_3.schema.json` defines
