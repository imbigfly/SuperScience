...
- `contracts/human_subjects/submission_packet_inventory.schema.json`
- `contracts/human_subjects/submission_packet_manifest.schema.json`
- `scripts/build_submission_packet_manifest.py`
- `contracts/human_subjects/irb_context_record.schema.json`
- `contracts/human_subjects/resolved_authority_context.schema.json`
- `human_subjects_authority_registry.json`
...
`references/authority_content_coverage_advisory_protocol.md`.
