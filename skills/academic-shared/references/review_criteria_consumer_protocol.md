...
Schemas:
`contracts/review_target/review_criteria_binding_manifest.schema.json`
and
`contracts/review_target/constructive_review_findings.schema.json`.
...
python scripts/review_criteria_binding.py init \
  ...
  --registry review_criteria_registry.json \
  --registry-ref review_criteria_registry.json \
