...
- `contracts/human_subjects/authority_profile_registry.schema.json`
...
- #681 consumes authority rows only through a #667 manifest that has first been
  ...
  through `references/authority_content_coverage_advisory_protocol.md`.
...
- #669 consumes every selected-profile requirement scoped to `pathway_trace`
  ...
  `references/review_pathway_rule_trace_protocol.md`. Its caller-owned
...
`references/submission_packet_manifest_protocol.md`.
