...
defined in `../academic-shared/references/review_criteria_consumer_protocol.md`. Every row
...
- The `evaluator_full` contract JSON (your acceptance criteria as defined in `../academic-shared/contracts/evaluator/full.json`).
